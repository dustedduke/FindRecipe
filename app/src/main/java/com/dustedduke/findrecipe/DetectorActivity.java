...
import com.dustedduke.findrecipe.customview.OverlayView;
import com.dustedduke.findrecipe.customview.OverlayView.DrawCallback;
import com.dustedduke.findrecipe.env.BorderedText;
    ...
    runInBackground(
        new Runnable() {
          ...
          public void run() {
            ...
            mappedRecognitions = new LinkedList<Classifier.Recognition>(); // final List<Classifier.Recognition>
