...
class RecipeAdapterSearch() : RecyclerView.Adapter<RecipeAdapterSearch.RecipeViewHolder>() {
    ...
    inner class RecipeViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemImage = itemView.findViewById(R.id.recipeImageViewSearch)
            itemTitle = itemView.findViewById(R.id.recipeTitleViewSearch)
            itemDescription = itemView.findViewById(R.id.recipeDescriptionViewSearch)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.recipe_card_search, parent, false)
        return RecipeViewHolder(v)
    }
